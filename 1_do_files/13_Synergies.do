...
#delimit;
xml_tab C,  save("$table\ESS_innovation_overlapNEW.xml") replace sheet("Table_1_ea_ess5", nogridlines)  ///
...
#delimit;
xml_tab C,  save("$table\ESS_innovation_overlapNEW.xml")  append sheet("Table_1_ea_oth_regions", nogridlines)  ///
rnames(`rname' "Total No. of obs. per region") cnames(`cnames') 
...
#delimit;
xml_tab C,  save("$table\ESS_innovation_overlapNEW.xml") append sheet("Table_2_hh_ess5", nogridlines)  ///
