...
write_csv(adopt_rates_w4_hh, file = "../tmp/adopt_reach/adopt_rates_w4_hh.csv")
...
write_csv(adopt_rate_dna_w4, file = "../tmp/adopt_reach/adopt_rate_dna_w4.csv")
...
write_csv(bd_means_w4, file = "../tmp/adopt_reach/bd_means_w4.csv")
