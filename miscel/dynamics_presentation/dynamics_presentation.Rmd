...
adoption_rates %>% 
  filter(variable %in% c("hhd_grassII", "ead_grassII")) %>% 
  plotShiny("Forages: Elephant Grass, Sesbaniya, Alfalfa, and Rhodes (Gaya)
")
...
### All forages in each wave

Forages in wave 4 include the above, i.e., Elephant Grass, Sesbaniya, Alfalfa, and Rhodes (Gaya). But forages in wave 5 include, in addition to these, Desho, Sinar, Lablab, and Vetch.

```{r foragesII, echo=FALSE}

adoption_rates %>% 
  filter(
    ((wave == "Wave 4" & variable == "hhd_grassII") | variable=="hhd_grass") | ((wave == "Wave 4" & variable == "ead_grassII") | variable=="ead_grass")
  ) %>% 
  plotShiny("All Forages")
...
## PSNP - Temporary Labor

```{r psnp4, echo=FALSE}

psnp %>% 
  filter(variable=="hhd_psnp") %>% 
  plotShiny_psnp("PSNP - Temporary Labor")
...
## PSNP - Temporary Labor or Direct Support

```{r psnp5, echo=FALSE}

psnp %>% 
  filter(variable=="hhd_psnp_any") %>% 
  plotShiny_psnp("PSNP - Temporary Labor or Direct Support")
